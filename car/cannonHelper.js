class CannonHelper {
    ...
    addLights(renderer) {
        ...
        const light = new THREE.DirectionalLight(0xc9a54f);
    ...
    addVisual(body, name, geometry = null, material = null, castShadow = true, receiveShadow = true) {
        body.name = name;
        console.log(name);
        if (this.currentMaterial === undefined) this.currentMaterial = new THREE.MeshPhongMaterial({ color: 0x888888 });
        if (this.settings === undefined) {
            ...
            this.particleMaterial = new THREE.MeshPhongMaterial({ color: 0xff0000 });
        }
        ...
        if(geometry) {
            if(material) {
                ...
                mesh = new THREE.Mesh(geometry, new THREE.MeshPhongMaterial({ color: 0x97df5e}))
            }
        }
        else if (body instanceof CANNON.Body) mesh = this.shape2Mesh(body, castShadow, receiveShadow);
        ...
        body.shapes.forEach(function (shape) {
            ...
            switch (shape.type) {
                ...
                case CANNON.Shape.types.PLANE:
                    material = new THREE.MeshPhongMaterial({ color: 0x5b95b5 })
